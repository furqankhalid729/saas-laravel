...
const PaymentTable = ({ invoices,user_id }) => {
    return (
        <div className='w-full bg-white shadow-lg'>
            <div className='w-[98%] mx-auto py-3 overflow-x-scroll hide-scrollbar'>
                ...
                <div className='flex gap-4 justify-between items-center h-[60px]'>
                    ...
                    <Link
                        href={route('agency.invoices.create', { user_id: user_id })}
                        className='flex items-center gap-1 text-white bg-black px-3 py-1 rounded-lg text-nowrap'
                    >
                ...
                <table className='w-full'>
                    <tbody>
                        ...
                        <tr className='text-[16px] capitalize  leading-[19px] font-[400] border-y border-[#808080] h-[40px]'>
                            ...
                            <td className='w-[20%] text-nowrap px-3'>Invoice ID</td>
                        ...
                        {invoices.map((data, index) => (
                            <tr key={index} className='text-[14px] leading-[16px] font-[500] border-b text-[#808080] border-[#808080] h-[40px]'>
                                ...
                                <td className='w-[20%] text-nowrap px-3'>{data.account_number}</td>
                                <td className='w-[20%] text-nowrap px-3 text-center'>{data.total}</td>
                                <td className='w-[20%] text-nowrap px-3 text-center'>{data.due_date}</td>
