...
let RecentTable = [
    { InvoiceSend: "T Clinic", incoiceId: "262455", name: "Adam Smith", amount: "$200.00", sendDate: "21/09/24", duedate: "10/10/24", color: "text-[#FFCC00]" },
    { InvoiceSend: "Davin Haley", incoiceId: "262455", name: "Warner Steave", amount: "$200.00", sendDate: "21/09/24", duedate: "10/10/24", color: "text-[#FFCC00]" },
    { InvoiceSend: "T Clinic", incoiceId: "262455", name: "Adam Smith", amount: "$200.00", sendDate: "21/09/24", duedate: "10/10/24", color: "text-[#1A7100]" },
    { InvoiceSend: "T Clinic", incoiceId: "262455", name: "Warner Steave", amount: "$200.00", sendDate: "21/09/24", duedate: "10/10/24", color: "text-[#1A7100]" },
    { InvoiceSend: "Davin Haley", incoiceId: "262455", name: "Adam Smith", amount: "$200.00", sendDate: "21/09/24", duedate: "10/10/24", color: "text-[#1A7100]" },
    { InvoiceSend: "T Clinic", incoiceId: "262455", name: "Warner Steave", amount: "$200.00", sendDate: "21/09/24", duedate: "10/10/24", color: "text-[#1A7100]" },
    { InvoiceSend: "T Clinic", incoiceId: "262455", name: "Adam Smith", amount: "$200.00", sendDate: "21/09/24", duedate: "10/10/24", color: "text-[#1A7100]" },
    { InvoiceSend: "T Clinic", incoiceId: "262455", name: "Warner Steave", amount: "$200.00", sendDate: "21/09/24", duedate: "10/10/24", color: "text-[#1A7100]" },
    { InvoiceSend: "Davin Haley", incoiceId: "262455", name: "Adam Smith", amount: "$200.00", sendDate: "21/09/24", duedate: "10/10/24", color: "text-[#1A7100]" },
        ...
        <div className='w-full bg-white rounded-xl shadow-2xl'>
            <div className='w-[98%] mx-auto min-h-[600px]'>
                ...
                <div className='h-[50px] flex items-center'>
                    <h1 className='font-[700] text-[24px] leading-[28px] px-2'>Upcoming Transactions</h1>
                </div>
                        ...
                        <tbody>
                            ...
                            {RecentTable.map((data, index) => (
                                <tr key={index} className='text-[14px] leading-[16px] font-[500] border-b text-[#808080] border-[#808080] h-[40px]'>
                                    ...
                                    <td className={`text-[#FF0000] w-[10%] text-nowrap px-3 text-center`}>Upcoming</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
