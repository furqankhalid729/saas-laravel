    ...
    return (
        <div className='w-full h-full flex flex-col justify-center items-center'>
            <div className='flex flex-col justify-center items-center gap-[50px] h-[620px] px-1 w-full'>
                ...
                <form className='flex flex-col gap-[50px] w-full sm:w-[360px]'>
                    {/* Inputs data */}
                    ...
                    <div className='flex flex-col gap-[18px] text-[16px] leading-[20px]'>
                        <Link href="/user/intake-form" className='font-[500] bg-black text-white hover:bg-gray-800 transition-all text-center w-full py-[18px] rounded-lg'>Login Now</Link>
